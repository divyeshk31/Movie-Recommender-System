...
if __name__ == '__main__':
	...
	"""
	Given sets of two vertices V1 = [n] , V2 = [n], with weights between them given as cost_matrix,
	To calculate matiching between these two such that total weight is maximum.
	Let the matrix be:
	cost_matrix = [
        [4, 2, 8],
        [4, 3, 7],
        [3, 1, 6]]
    Expected result = 14 (by selecting 8, 3, 3)

    Since the above algo returns minimum total weight, make all values negative and send it to function, which will
    return us the minimum weight, take abs() of the answer and print it, which will be maximum matching b/w the
    2 sets of vertices.
	"""
	...
	hungarian.calculate()
	print("Calculated value:\t", abs(hungarian.get_total_potential()))
